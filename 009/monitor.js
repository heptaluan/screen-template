...
function renderChartBar01() {
  ...
  myChart.setOption({
    ...
    calculable: true,
    color: [
      COLOR.MACHINE.TYPE_A,
      COLOR.MACHINE.TYPE_B,
      COLOR.MACHINE.TYPE_C,
      COLOR.MACHINE.TYPE_D,
      COLOR.MACHINE.TYPE_E,
      COLOR.MACHINE.TYPE_F,
      COLOR.MACHINE.TYPE_G,
    ],
    series: [
      {
        name: '',
    ...
    series: [
      {
        ...
        areaStyle: {
          normal: {
            color: new echarts.graphic.LinearGradient(
              ...
              1,
              [
                { offset: 0, color: '#026B6F' },
                { offset: 1, color: '#012138' },
              ],
              false
            ),
            opacity: 0.2,
        ...
        symbol: 'none',
        data: [
          48, 52, 45, 46, 89, 120, 110, 100, 88, 96, 88, 45, 78, 67, 89, 103, 104, 56, 45, 104, 112, 132, 120, 110, 89,
          95, 90, 89, 102, 110, 110,
        ],
      },
    ],
  })
...
function get10MinutesScale() {
  ...
  for (var i = 0; i < 7; i++) {
    returnArr.push(
      currDate.getHours() + ':' + (currDate.getMinutes() < 10 ? '0' + currDate.getMinutes() : currDate.getMinutes())
    )
