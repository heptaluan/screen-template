...
$(document).ready(function () {
  ...
  //产品销售的环形图
  var productLegend = [
    ['轿车1', '轿车2', '轿车3', '轿车4', '轿车5', '轿车6', '轿车7', '轿车8', '轿车9'],
    ['SUV1', 'SUV2', 'SUV3', 'SUV4'],
    ['卡车1', '卡车2', '卡车3', '卡车4', '卡车5', '卡车6'],
  ]
...
function resresh() {
  ...
  $('#currentDate').html(
    myDate.getFullYear() + '/' + insertZero(myDate.getMonth() + 1) + '/' + insertZero(myDate.getDate())
  )
