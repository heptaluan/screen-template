  ...
  xining: [
    {
      data: bar_data1,
      label: '照明能耗',
      bars: { show: true, barWidth: 0.3, order: 1, fill: 1, lineWidth: 0, fillColor: 'rgba(255,255,255,0.6)' },
    },
    {
      data: bar_data2,
      label: '照明能耗',
